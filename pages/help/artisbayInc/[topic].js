...
const topics = {
  help: [
    ...
    { name: 'About Us', slug: 'about-us', component: 'CompanyProfile', image: '/images/companyprofile.png' },
    { name: 'Bank Information', slug: 'bank-information', component: 'BankInformation', image: '/images/bankinfo.png' },
...
const topicMeta = {
  help: {
    title: 'Artisbay Lite Help Center | Artisbay Lite Inc.',
    description: 'Find out how to buy, company profile, bank information, FAQs, and more.',
    keywords: 'Artisbay Lite, help, company profile, bank information, FAQs'
  },
  'how-to-buy-used-cars': {
    title: 'How to Buy Used Cars | Artisbay Lite Inc.',
    description: 'Step-by-step guide on purchasing used cars from Japanese auctions via Artisbay Lite.',
    keywords: 'buy used cars, Artisbay Lite, Japanese auctions, how to buy'
  },
  'about-us': {
    title: 'About Us  | Artisbay Lite Inc. ',
    description: 'Learn about Artisbay Lite’s mission, history, and the team behind our car-buying platform.',
    keywords: 'Artisbay Lite, company profile, about us'
  },
  'bank-information': {
    title: 'Bank Information | Artisbay Lite Inc.',
    description: 'All our official banking details for wire transfers, TT, Wise and PayPal.',
    keywords: 'Artisbay Lite, bank details, wire transfer, TT, Wise, PayPal'
  },
...
export default function HelpPage({ initialSlug }) {
 ...
 const handleScroll = useCallback(() => {
  ...
  const meta = topicMeta[selectedTopic.slug] || {
    title: `${selectedTopic.name} | Artisbay Lite Inc.`,
    description: `Learn more about ${selectedTopic.name} at Artisbay Lite Inc.`,
    keywords: `${selectedTopic.name.toLowerCase()} | Artisbay Lite Inc.`
  };
  ...
  const handleTopicChange = topic => {
    ...
    router.push(`/help/artisbayInc/${topic.slug}`);
