...
const agreementContent = (
  ...
  <div>
    <section>
        ...
        <p>
          Artisbay Lite Ltd. (hereinafter referred to as “the Company”) enforces a strict policy against any dealings, affiliations, or interactions with individuals or entities connected to anti-social force. This includes, but is not limited to, criminal organizations, violent groups, or those associated with such entities (hereinafter referred to as “Anti-Social Forces”).
        </p>
      </section>
      <section>
