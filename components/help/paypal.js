...
const PaypalInfo = () => {
  return (
    <div className='paypal'>
      ...
      <ol>
        <li>Click <a className='cta-link paypal-link' rel="noreferrer" target='_blank' href="https://www.paypal.com/ca/for-you/account/create-account">Sign up for a PayPal account</a>.</li>
