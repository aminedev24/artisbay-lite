...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($stmtInsert->execute()) {
            ...
            // Send email notification via SMTP (MailHog on :1025 in dev)
            try {
